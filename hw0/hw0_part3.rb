...
# price as second argument, and should raise ArgumentError (one of Ruby's built-in exception types) 
...
# Include a method price_as_string that returns the price of the book with a leading dollar sign 
# and trailing zeros, 
...
raise "book.price_as_string != '$20.00'" unless book.price_as_string == '$20.00'

book.price = 33.8

raise "book.price_as_string != '$33.80'" unless book.price_as_string == '$33.80'